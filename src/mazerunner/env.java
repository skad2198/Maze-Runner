...
public class env {
    ...
    env(int[][] maze, int xstart, int ystart, boolean diag) {
    ...
    */
    public List<Node> findPathTo(int xend, int yend) {
        ...
        this.closed.add(this.now); //Remove start point from fringe.
...
//        }
	...
	public static void main(String[] args) {
        ...
        List<Node> path = as.findPathTo(dim-1, dim-1);
